...
function hideMenu() {
    ...
    $("#menu_container").animate({left: "0"}, 250);
    $('.menu-background').hide();
}
//MENU SHOW
function showMenu() {
    $("#window_menu").stop(true, true).animate({width: "100%"}, 250);
    $("#container").stop(true, true).animate({left: "20%"}, 250);
    $("#menu_container").stop(true, true).animate({left: "20%"}, 250);
